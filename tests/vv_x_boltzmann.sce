...
// In the case of g != 0 the probability distribution of the position should
// follow a Boltzmann distribution and the program checks if this is satisfied
// for a simple potential V(x) = (1/2)*k*x^2
