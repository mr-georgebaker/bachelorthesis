...
void print_init(int amount, int refresh, int timesteps, int threads, int threads_copy, int dump, int copies, int reset_steps, int exchange_rate, double dt, double temp, double mass, double friction, double density_in, double region_length, double cutoff_radius, int seed, double difference, double second_well, double height, double temp_spacing, double bond_length, bool periodic, bool periodic_xz, bool reset_origin, bool parallel, bool init_pos, bool init_vel, bool double_well, bool out_pos, bool polymer, const char* init_pos_file, const char* init_vel_file, const char* out_pos_file){
