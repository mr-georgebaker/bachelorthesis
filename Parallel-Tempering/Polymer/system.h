...
class Particles{
  public:
    ...
    double * rnd;
    int ** neighborlist;
    void init(int amount_in, int threads_in, int refresh_in, int reset_steps_in, double dt_in, double temp_in, double mass_in, double friction_in, double region_length_in, double cutoff_radius_in, double difference_in, double second_well_in, double height_in, double bond_length_in, bool periodic_in, bool periodic_xz_in, bool reset_origin_in, bool init_pos_in, bool init_vel_in, bool double_well_in, bool polymer_in, const char* init_pos_file_in, const char* init_vel_file_in);
...
void Particles::init(int amount_in, int threads_in, int refresh_in, int reset_steps_in, double dt_in, double temp_in, double mass_in, double friction_in, double region_length_in, double cutoff_radius_in, double difference_in, double second_well_in, double height_in, double bond_length_in, bool periodic_in, bool periodic_xz_in, bool reset_origin_in, bool init_pos_in, bool init_vel_in, bool double_well_in, bool polymer_in, const char* init_pos_file_in, const char* init_vel_file_in){
  amount = amount_in;
  threads = threads_in;
  refresh = refresh_in;
...
class System{
  public:
    Particles particles;
    void init(int amount_in, int timesteps_in, int refresh_in, int threads_in, int dump_in, int reset_steps_in, double dt_in, double temp_in, double mass_in, double friction_in, double density_in, double region_length_in, double cutoff_radius_in, double bond_length, bool periodic_in, bool periodic_xz_in, bool reset_origin_in, bool init_pos_in, bool init_vel_in, bool polymer, const char* init_pos_file_in, const char* init_vel_file_in, bool double_well_in, double difference_in, double second_well_in, double height_in);
    void update_neighborlist(void);
    void update_forces(void);
    void update_positions(void);
    void update_velocities(void);
...
void System::init(int amount_in, int timesteps_in, int refresh_in, int threads_in, int dump_in, int reset_steps_in, double dt_in, double temp_in, double mass_in, double friction_in, double density_in, double region_length_in, double cutoff_radius_in, double bond_length_in, bool periodic_in, bool periodic_xz_in, bool reset_origin_in, bool init_pos_in, bool init_vel_in, bool polymer_in, const char* init_pos_file_in, const char* init_vel_file_in, bool double_well_in, double difference_in, double second_well_in, double height_in){
// System initializer
  amount = amount_in;
  ...
  second_well = second_well_in;
  height = height_in;
  particles.init(amount, threads, refresh, reset_steps, dt, init_temp, mass, friction, region_length, cutoff_radius, difference, second_well, height, bond_length, periodic, periodic_xz, reset_origin, init_pos, init_vel, double_well, polymer, init_pos_file, init_vel_file);
}
