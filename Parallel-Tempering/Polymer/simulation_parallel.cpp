...
int main(int argc, char* argv[]){
  ...
  */
  ...
  print_init(amount, refresh, timesteps, threads, threads_copy, dump, copies, reset_steps, exchange_rate, dt, temp, mass, friction, density, region_length, cutoff_radius, seed, difference, second_well, height, temp_spacing, bond_length, periodic, periodic_xz, reset_origin, parallel_tempering, init_pos, init_vel, double_well, out_pos, polymer, init_pos_file, init_vel_file, out_pos_file);
  ...
  for (int i=0; i<copies; ++i){
    systems[i].init(amount, timesteps, refresh, threads_copy, dump, reset_steps, dt, temperatures[i], mass, friction, density, region_length, cutoff_radius, bond_length, periodic,periodic_xz,reset_origin, init_pos,init_vel,polymer, init_pos_file,init_vel_file, double_well, difference, second_well, height);
